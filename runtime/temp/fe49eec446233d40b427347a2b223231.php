<?php /*a:2:{s:73:"D:\work\code\mchat_gamming_adm\application\admin\view\role\privilege.html";i:1566974819;s:70:"D:\work\code\mchat_gamming_adm\application\admin\view\public\base.html";i:1566960893;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<link rel="stylesheet" href="<?php echo htmlentities($ctrl_res_url); ?>/css/privilege.css">
...
<div class="body-header">
    <div class="left">当前正在修改角色</div>
    <div class="right"><?php echo htmlentities($role->name); ?></div>
</div>

<div id="tree"></div>

<div class="submit">
    <button class="layui-btn" id="allocate">分配权限</button>
</div>
...
<script src="<?php echo htmlentities($ctrl_res_url); ?>/js/privilege.js"></script>
