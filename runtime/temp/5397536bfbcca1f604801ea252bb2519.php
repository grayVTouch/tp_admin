<?php /*a:2:{s:74:"D:\work\code\mchat_gamming_adm\application\admin\view\community\thing.html";i:1567417955;s:72:"D:\work\code\mchat_gamming_adm\application\admin\view\public\iframe.html";i:1563525905;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" id="form">
    ...
    <div class="layui-form-item <?php if($mode == 'edit' && $thing->type == 3): ?>layui-hide<?php endif; ?>">
        <label class="layui-form-label">iphone程序链接</label>
        <div class="layui-input-block">
            <input type="text" name="url" required="required" value="<?php echo isset($thing->url) ? htmlentities($thing->url) : ''; ?>" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="download_url" required="required" value="<?php echo isset($thing->download_url) ? htmlentities($thing->download_url) : ''; ?>" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="android_url" required="required" value="<?php echo isset($thing->android_url) ? htmlentities($thing->android_url) : ''; ?>" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="android_download_url" required="required" value="<?php echo isset($thing->android_download_url) ? htmlentities($thing->android_download_url) : ''; ?>" class="layui-input">
        </div>
    </div>
