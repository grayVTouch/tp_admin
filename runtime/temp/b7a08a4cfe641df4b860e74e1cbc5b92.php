<?php /*a:2:{s:64:"D:\work\code\lucky\application\admin\view\translation\thing.html";i:1568684980;s:60:"D:\work\code\lucky\application\admin\view\public\iframe.html";i:1563525905;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" id="form">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">中文<b class="font-red">*</b></label>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">英文<b class="font-red">*</b></label>
        <div class="layui-input-block">
            <input type="text" name="en" required="required" value="<?php echo isset($thing->en) ? htmlentities($thing->en) : ''; ?>"  lay-verify="required" class="layui-input">
        </div>
    </div>

    <div class="layui-form-item">
        <label class="layui-form-label">标识符<b class="font-red">*</b></label>
        <div class="layui-input-block">
            <input type="text" name="ident" required="required" value="<?php echo isset($thing->ident) ? htmlentities($thing->ident) : ''; ?>"  lay-verify="required" class="layui-input">
        </div>
    </div>
