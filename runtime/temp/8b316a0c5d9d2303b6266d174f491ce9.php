<?php /*a:2:{s:76:"D:\work\code\mchat_gamming_adm\application\admin\view\transfer_out\list.html";i:1571119442;s:70:"D:\work\code\mchat_gamming_adm\application\admin\view\public\base.html";i:1566960893;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="coin_id">
                        ...
                        <option value="<?php echo htmlentities($v->id); ?>"><?php echo htmlentities($v->cname); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="width:300px;">
                    <input type="text" name="date_range" class="layui-input" id="date_range" placeholder="YYYY-MM-DD - YYYY-MM-DD">
                </div>
            </div>
...
<script type="text/html" id="operation">
    <button class="layui-btn layui-btn-xs" lay-event="balance">审核</button>
