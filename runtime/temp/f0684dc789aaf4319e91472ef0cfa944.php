<?php /*a:2:{s:73:"D:\work\code\lucky\application\admin\view\friend_circle_comment\list.html";i:1567406125;s:61:"D:\work\code\lucky\application\admin\view\public\im_base.html";i:1567405690;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="operation">
    <!--<button class="layui-btn" data-href="<?php echo htmlentities($ctrl_url); ?>/addView?mode=add" id="add"><i class="layui-icon">&#xe654;</i>添加</button>-->
...
<script src="/module/im/public/js/lib.js?version=<?php echo htmlentities($version); ?>"></script>
<script src="/module/im/public/js/global.js?version=<?php echo htmlentities($version); ?>"></script>
<script src="/module/im/public/js/currency.js?version=<?php echo htmlentities($version); ?>"></script>
<script src="/module/im//public/js/public.js?version=<?php echo htmlentities($version); ?>"></script>

<script type="text/html" id="operation">
    <!--<div class="line"><a class="layui-btn layui-btn-xs" lay-event="edit"><i class="layui-icon">&#xe642;</i>编辑</a></div>-->
    <a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="del"><i class="layui-icon">&#xe640;</i>删除</a>
</script>
<script src="/module/im/friend_circle_comment/js/list.js?version=<?php echo htmlentities($version); ?>"></script>
