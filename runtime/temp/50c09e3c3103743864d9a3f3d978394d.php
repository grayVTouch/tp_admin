<?php /*a:2:{s:66:"D:\work\code\lucky\application\admin\view\balance_record\list.html";i:1567749848;s:58:"D:\work\code\lucky\application\admin\view\public\base.html";i:1566960893;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="type">
                        <option value="">请选择...</option>
                        <?php foreach($balance_record_type as $v): ?>
                        <option value="<?php echo htmlentities($v->code); ?>"><?php echo htmlentities($v->name); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
