(function(){
    ...
    var app = {
        data: {
            listUrl: '/admin/game_tq_record/list' ,
            delUrl: '/game_tq_record/del' ,
            updateUrl: '/game_tq_record/update' ,
            editUrl: '/admin/game_tq_record/editView?mode=edit&id=' ,
            dom: {} ,
            tableId: 'table' ,
            filter: {} ,
        } ,
                ...
                cols: [
                    [
                        ...
                        } ,
                        {
                            ...
                            title: 'uid',
                            templet (res) {
                                return `<button class="layui-btn layui-btn-xs" lay-event="game_record">【uid: ${res.uid}】游戏记录</button>`;
                            } ,
                        } ,
                        {
                            fixed: 'left' ,
        ...
        initEvent: function(){
            ...
            layui.table.on('tool(table)', function(res){
                ...
                {
                    case 'game_record':
                        toLink('/game_record/listView?uid=' + res.data.uid);
                        break;
                }
            });
