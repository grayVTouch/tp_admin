...
class BbOrderAction extends Action
{
    public static function list(array $param)
    {
        $param['limit'] = empty($param['limit']) ? config('app.limit') : $param['limit'];
        $order = parse_order($param['order']);
        $res = BbOrderModel::list($param , $order , $param['limit']);
    ...
    public static function add(array $param)
    {
        ...
        $id = BbOrderModel::insertGetId(array_unit($param , [
            'param' ,
            'val' ,
            'is_show' ,
            'discription' ,
    ...
    public static function edit(array $param)
    {
        ...
        BbOrderModel::updateById($m->id , array_unit($param , [
            'param' ,
            'val' ,
            'is_show' ,
            'discription' ,
    ...
    public static function update(array $param)
    {
        ...
        BbOrderModel::updateById($param['id'] , array_unit($param , [
            'buy_fee_rate' ,
            'sell_fee_rate' ,
        ]));
        return self::success('操作成功');
