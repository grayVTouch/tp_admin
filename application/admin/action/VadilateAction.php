...
class VadilateAction extends Action {

	public static function list(array $param) {
		$param['limit'] = empty($param['limit']) ? config('app.limit') : $param['limit'];
		$order = parse_order($param['order']);
		$res = VadilateModel::list($param, $order, $param['limit']);
	...
	public static function add(array $param) {
		...
		$id = VadilateModel::insertGetId(array_unit($param, [
				'key',
				'val',
				'discript',
		]));
	...
	public static function edit(array $param) {
		...
		VadilateModel::updateById($m->id, array_unit($param, [
			'to_time',
		]));
	...
	public static function del(array $param) {
		...
		VadilateModel::delByIds($id_list);
	...
	public static function update(array $param) {
		...
		VadilateModel::updateById($param['id'], array_unit($param, [
			'val',
		]));
		return self::success('操作成功');
	}
