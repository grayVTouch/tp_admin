...
class TranslationAction extends Action
{
    public static function list(array $param)
    {
        ...
        $res = TranslateModel::list($param , $order , $param['limit']);
    ...
    public static function add(array $param)
    {
        ...
        $id = TranslateModel::insertGetId(array_unit($param , [
            'name' ,
            'en' ,
            'ident' ,
        ]));
    ...
    public static function edit(array $param)
    {
        ...
        TranslateModel::updateById($m->id , array_unit($param , [
            'name' ,
            'en' ,
            'ident' ,
        ]));
    ...
    public static function del(array $param)
    {
        ...
        TranslateModel::delByIds($id_list);
